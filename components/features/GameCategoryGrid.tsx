    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
      {categories.map((category) => (
        <Link
          ...
          key={category.id}
          className="group relative bg-white rounded-lg border border-slate-200 p-4 hover:bg-slate-50 transition-colors duration-200"
        >
          {/* Image Frame */}
          <div className="aspect-video w-full bg-slate-50 border border-slate-200 rounded-lg flex items-center justify-center mb-4 group-hover:border-slate-300 transition-colors">
